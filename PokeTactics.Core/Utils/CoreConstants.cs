namespace PokeTactics.Core.Utils
{
    public static class CoreConstants
    {
        // Restrictions to properties length
        public const int MaxTypesListCount = 2;
        public const int MaxStatsListCount = 6;
        public const int MaxAbilitiesListCount = 3;
        public const int MaxPokemonNameLength = 30;
        public const int MaxAbilityNameLength = 20;

        // TODO Check if less length for move name is ok
